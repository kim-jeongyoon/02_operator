...
public class OpExample {
	...
	public void ex3() {
		//전위연산: ++3, --2 연산자가 앞쪽에 배치 --> 다른 연산보다 먼저 증감/감소
		int temp1 = 5;
		System.out.println(++temp1 + 5);// 11
		
		//후위연산: 3++, --2 연산자가 뒤쪽에 배치 --> 다른 연산보다 나중에 증감/감소
		
		int temp2= 3;
		System.out.println(temp2-- + 2); // 5
		// 3 + 2 = 5
		// temp2 <= 2 (1감소) --> 연산부터하고 감소
	...
	public void ex4() {
		...
		System.out.println(a!=b);//true --> a와 b는 같지X
		System.out.println((a==b) == false);//true --> ()괄호 안에 있는거 먼저 연산
		
		int c = 4;
		int d = 5;
		System.out.println(c+1 <= d); // true --> 산술연산이 비교연산보다 우선순위 높음
		
		int temp = 723;
		System.out.println("temp는 짝수인가요? " + (temp%2 == 0)); //true
	...
	public void ex5() {
		...
		int a = 101; // a는 100이상이면서 짝수 인가?
		System.out.println((a >= 100) && (a%2 == 0)); // false
		
		int c = 10; // c는 10을 초과했거나 짝수 인가?
		System.out.println((c > 10) || (c%2 == 0)); // true
		//둘다 false면 false, 나머지는 true
	...
	public void ex8() {
		...
		System.out.println(result); // num은 30 이하다  
